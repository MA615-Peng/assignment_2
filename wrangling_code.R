...
#added fileEncoding = "UTF-8-BOM" so the column "country" would import properly
pol_rural <- read.csv("sp_rur_totl_zs.csv", header=T, check.names = FALSE, fileEncoding = "UTF-8-BOM")
pol_urban <- read.csv("sp_urb_totl_in_zs.csv", header=T, check.names = FALSE, fileEncoding = "UTF-8-BOM")
san_rural <- read.csv("at_least_basic_sanitation_rural_access_percent.csv", header=T, check.names = FALSE, fileEncoding = "UTF-8-BOM")
san_urban <- read.csv("at_least_basic_sanitation_urban_access_percent.csv", header=T, check.names = FALSE, fileEncoding = "UTF-8-BOM")
